                        ...
                        {availability.map((item, index) => (
                            <div key={index} className="flex flex-wrap items-center gap-4 p-4 border border-gray-100 rounded-lg bg-gray-50 group transition-all hover:shadow-sm">
                                <div className="flex-1 min-w-[150px]">
                                    <label className="label text-xs font-semibold text-gray-500 uppercase tracking-wider">Day</label>
                                    <select
                                ...
                                <div className="flex-1 min-w-[120px]">
                                    <label className="label text-xs font-semibold text-gray-500 uppercase tracking-wider">Start Time</label>
                                    <input
                                        type="time"
                                ...
                                <div className="flex-1 min-w-[120px]">
                                    <label className="label text-xs font-semibold text-gray-500 uppercase tracking-wider">End Time</label>
                                    <input
                                        type="time"
                                        className="input input-bordered input-sm w-full bg-white"
                                        value={item.endTime}
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                        ...
                        <div className="flex gap-3 w-full md:w-auto">
                            ...
                            <button
                                onClick={handleSave}
                                disabled={loading}
                                className={`btn btn-primary btn-sm min-w-[120px] rounded-lg shadow-md shadow-blue-100 ${loading ? 'loading' : ''}`}
                            >
